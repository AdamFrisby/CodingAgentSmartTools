...
public abstract class BaseLspCommand : Command<BaseLspCommand.Settings>
{
    ...
    protected async Task<LspClient?> CreateLspClientAsync(Settings settings)
    {
    ...
    public Task<LspClient?> CreateLspClientAsyncPublic(Settings settings) => CreateLspClientAsync(settings);
